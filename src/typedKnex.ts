...
let beforeInsertTransform = undefined as undefined | ((item: any, typedQueryBuilder: any) => any);

export function registerBeforeInsertTransform<T>(f: (item: T, typedQueryBuilder: ITypedQueryBuilder<{}, {}, {}>) => T) {
    beforeInsertTransform = f;
}

let beforeUpdateTransform = undefined as undefined | ((item: any, typedQueryBuilder: any) => any);

export function registerBeforeUpdateTransform<T>(f: (item: T, typedQueryBuilder: ITypedQueryBuilder<{}, {}, {}>) => T) {
...
interface ISelectQuery<Model, SelectableModel, Row> {
    <TReturn extends Boolean | String | Number, TName extends keyof any, SubQueryModel>(
        name: TName,
...
function getProxyAndMemoriesForArray<ModelType, Row>(typedQueryBuilder?: TypedQueryBuilder<ModelType, Row>) {
...
export class TypedQueryBuilder<ModelType, SelectableModel, Row = {}> implements ITypedQueryBuilder<ModelType, SelectableModel, Row> {
    ...
    public async updateItemByPrimaryKey(primaryKeyValue: any, item: Partial<RemoveObjectsFrom<ModelType>>) {
        if (beforeUpdateTransform) {
            item = beforeUpdateTransform(item, this);
        }
    ...
    public havingNotIn() {
        const value = arguments[1];
        (this.queryBuilder as any).havingNotIn(this.getColumnNameFromFunctionOrString(arguments[0]), value);
        return this;
    }

    public havingNull() {
        (this.queryBuilder as any).havingNull(this.getColumnNameFromFunctionOrString(arguments[0]));
        return this;
    }

    public havingNotNull() {
        (this.queryBuilder as any).havingNotNull(this.getColumnNameFromFunctionOrString(arguments[0]));
        return this;
    }
    ...
    public havingBetween() {
        const value = arguments[1];
        (this.queryBuilder as any).havingBetween(this.getColumnNameFromFunctionOrString(arguments[0]), value);
        return this;
    }

    public havingNotBetween() {
        const value = arguments[1];
        (this.queryBuilder as any).havingNotBetween(this.getColumnNameFromFunctionOrString(arguments[0]), value);
        return this;
    }
    ...
    private functionWithAlias(knexFunctionName: string, f: any, aliasName: string) {
        this.hasSelectClause = true;
        (this.queryBuilder as any)[knexFunctionName](`${this.getColumnNameWithoutAliasFromFunctionOrString(f)} as ${aliasName}`);
        return this as any;
    }
