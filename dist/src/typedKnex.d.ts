...
export declare type Granularity = "PAGLOCK" | "NOLOCK" | "READCOMMITTEDLOCK" | "ROWLOCK" | "TABLOCK" | "TABLOCKX";
export declare class TypedQueryBuilder<ModelType, SelectableModel, Row = {}> implements ITypedQueryBuilder<ModelType, SelectableModel, Row> {
    ...
    private applyTemporalConversionsForRead;
    private flattenByOption;
    private joinTableOnFunction;
    private getTypedKnexOnObject;
    private TEMPORAL_CLASS_NAMES;
    private isTemporalClass;
    private isTemporalValue;
    private convertTemporalParam;
