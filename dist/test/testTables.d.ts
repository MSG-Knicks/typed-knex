...
export declare class NoLockTable {
    id: string;
    name: string;
}
export declare class UserSetting {
    ...
    initialValue: string;
    otherValue: string;
    noLockColumn: NoLockTable;
}
export declare class correctTableName {
    id: string;
    code: number;
}
export declare class TemporalTestClassTable {
    id: string;
    temporalDateColumn: Temporal.PlainDate;
    temporalTimeColumn: Temporal.PlainTime;
    temporalDateTimeColumn: Temporal.PlainDateTime;
    sqlDateColumn: Date;
